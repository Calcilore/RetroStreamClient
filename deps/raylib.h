...
// This has been slightly modified from normal
// it is in a namespace to abide by things like Rectange and CloseWindow being taken
// and #include <stdarg.h> and the TraceLogCallback function do not work, so i removed them

#ifndef RAYLIB_H
#define RAYLIB_H

namespace raylib {
// with this it doesn't compile, so I removed this and TraceLogCallback
